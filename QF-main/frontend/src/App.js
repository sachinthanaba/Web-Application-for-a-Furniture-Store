...
import UpdateProfile from "./components/UpdateProfile.css/UpdateProfile";
import UpdateShipping from "./components/UpdateShipping/UpdateShipping";
const App = () => {
  return (
    <BrowserRouter>
      <Navbar />
      ...
      <Routes>
        ...
        <Route path="/shipping-update/:userId" element={<UpdateShipping/>} />
        <Route
