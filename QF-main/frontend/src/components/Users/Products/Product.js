...
const product = {
  ...
  sizes: [
    { name: "Wood", inStock: true },
    { name: "Metal", inStock: true },
    { name: "Upholstery Fabric", inStock: true },
    { name: "Particleboard and MDF", inStock: true },
    { name: "Plastic", inStock: true }
  ],
...
const policies = [
  ...
  },
  {
    ...
    description: "Take special discount",
  },
];
