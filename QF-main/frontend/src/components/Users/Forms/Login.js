          ...
          <div className="relative flex flex-wrap bg-white">
            <div className="w-full md:w-4/6 px-4">
              <div className="lg:max-w-3xl mx-auto py-20 px-4 md:px-10 lg:px-20">
                ...
                >
                  <div className="w-full md:w-1/3 px-4 mb-8 md:mb-12">
                    <label>
                  ...
                  <div className="w-full px-4">
                    {loading ? (
                      ...
                      <button className="bg-blue-800 hover:bg-blue-900 text-white font-bold font-heading py-3 px-8 rounded-md uppercase">
                        Login
                      </button>
                    )}
                  </div>
            ...
            <div
              ...
              style={{
                backgroundImage:
                  'url("https://img.freepik.com/free-photo/hotel-room-with-comfortable-couch_1203-1488.jpg?w=360&t=st=1695148351~exp=1695148951~hmac=d8463985f1dd0ebfd10409e7717999001b1b5db8cedd125f70300dd31c6d6a79")',
              }}
            ></div>
          </div>
        </div>
