...
export default function CustomerProfile() {
  ...
  const handleUpdateOnClick = () => {
    navigate(`/profile-update/${profile.user._id}`);
  }
  const handleUpdateShippingOnClick = () => {
    navigate(`/shipping-update/${profile.user._id}`)
  }
        ...
        <div className="flex flex-wrap -mx-3 -mb-3 md:mb-0">
          ...
          <div className="w-full md:w-1/2 px-3 mb-3 md:mb-0">
            ...
            <div style={{ marginTop: "10px" }}>
              <button style={{ backgroundColor: "yellow" }} type="button" class="btn btn-warning" onClick={handleUpdateShippingOnClick}>Update Shipping Address Details</button>
            </div>
